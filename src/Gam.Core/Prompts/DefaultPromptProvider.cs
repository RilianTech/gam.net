...
/// Enhanced with ADR-0002 memory metadata (type, importance, tags).
/// </summary>
public static class DefaultPrompts
{
    /// <summary>
    /// Memory system prompt - now uses JSON format with type/importance/tags (ADR-0002).
    /// </summary>
    public const string MemorySystem = MemoryPrompts.AbstractSystemPrompt;
